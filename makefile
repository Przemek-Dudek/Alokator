...
# Znacznik czasowy: 2022-12-12 19:23:04.715290
#

OUTDIR		:= build-dir

CC          := gcc
CC_FLAGS    := -Werror -pedantic -fmax-errors=5 -Wno-error=implicit-fallthrough -D_GNU_SOURCE -Wno-error=unused-parameter -DINSIDE_DANTE -Wno-parentheses -D_ANSI_OUTPUT -ggdb3 -Wall -xc -Wno-error=parentheses -std=c11 -Werror=vla -fdiagnostics-color -Wextra 
